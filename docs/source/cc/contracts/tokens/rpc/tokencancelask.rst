...
To cancel any ask/sell order that you created
=============================================

All you need is the specific ``tokenid`` & ``asktxid`` which can be found on the order.
...
Step 3: Decode the raw transaction (check if the values are sane)
=================================================================
