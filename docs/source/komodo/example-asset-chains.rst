...
The values of parameters other than ``ac_name`` in these examples are completely arbitrary. The names of these example-asset-chains are assigned based on how a chain is customized and it's grouping.
